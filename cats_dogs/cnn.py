...
def inference(images, batch_size, n_classes):
    ...
    ====================
    Args:
        images: image batch, 4D tensor, tf.float32.
        batch_size: Batch training size.
        n_classes: Classification number.
    ====================
    Returns:
        output tensor with the computed logits, float.
    """
    ...
    # conv2, shape = [kernel size, kernel size, channels, kernel numbers]
