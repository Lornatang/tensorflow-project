...
def distorted_inputs():
    """
        Construct distorted input for CIFAR training using this.
    ====================
    Returns:
    ...
    images, labels = train_test_split.distorted_inputs(
...
def inputs(eval_data):
    """
        Construct input for CIFAR evaluation using this.
    ====================
    Args:
    ...
    if not FLAGS.data_dir:
        raise ValueError('Please supply a data_dir')
    data_dir = os.path.join(FLAGS.data_dir, 'cifar-10-batches-bin')
    images, labels = train_test_split.inputs(eval_data=eval_data,
                                             data_dir=data_dir,
